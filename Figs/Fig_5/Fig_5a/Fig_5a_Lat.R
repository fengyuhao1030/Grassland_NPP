...
dataMatrix <- read.csv('ANPP_LatSum.csv')
...
Fig_3a_Lat <- ggplot()+
  ...
  scale_y_continuous(limits = c(0,1100),breaks = seq(0,1000,250),labels = c('0','250','500','750','1000'),expand = c(0,0))+
  ylab('ANPP')+
  coord_flip()+
  theme_custom()
pdfName <- paste0(dirname(rstudioapi::getActiveDocumentContext()$path),'\\Fig_3a_Lat.pdf')
